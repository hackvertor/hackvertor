...
public class SearchPanel extends JPanel {
        ...
        searchBox.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent e) {
                ...
                try {
                    ...
                    HackvertorExtension.stderr.println(ex);
                    return;
                }
    ...
    void search(String findText, JTextArea element, Boolean regex) {
        try {
            Highlighter.HighlightPainter painter = new DefaultHighlighter.DefaultHighlightPainter(HackvertorExtension.isDarkTheme ? Color.gray : Color.yellow);
